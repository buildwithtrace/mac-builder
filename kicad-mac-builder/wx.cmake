...
ExternalProject_Add(
    ...
    UPDATE_COMMAND      ""
    PATCH_COMMAND       ${PYTHON_INSTALL_DIR}/Python.framework/Versions/Current/bin/python3 ${CMAKE_SOURCE_DIR}/patch_wxpython_build.py
    CONFIGURE_COMMAND   ""
...
ExternalProject_Add_Step(
    wxpython
    patch_build_py
    COMMENT "Patching build.py to add missing [tool.sip.metadata] section"
    DEPENDEES prep_dox
    DEPENDERS build
    WORKING_DIRECTORY <SOURCE_DIR>
    COMMAND ${PYTHON_INSTALL_DIR}/Python.framework/Versions/Current/bin/python3 ${CMAKE_SOURCE_DIR}/patch_wxpython_build.py
    ALWAYS 1
)
